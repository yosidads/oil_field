...
#Note: This code was originally at http://www.pygame.org/pcr/text_rect/index.php
...
def render_textrect(string, font, rect, text_color, background_color, justification=0):
    ...
    for line in final_lines: 
        ...
        if line != "":
            tempsurface = font.render(line, False, text_color)  #If you want to make the message anti-aliased, set True.
            if justification == 0:
